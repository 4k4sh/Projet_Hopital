...
/**
    ...
    if(serv1.getIdService().equals(id)){
        erreur+=" le service existe d̩ja ";
    }
    }
    ...
    /**
     * On affiche un message d'erreur personnalis̩ sur les champs mal
     * remplis
     * @param error
     * @return 
     */
    ...
    if (error.length() == 0) {
            ...
            alert.setTitle("Entr̩e invalide");
            alert.setHeaderText("Corriger les entr̩es invalides suivantes:");
